...
public class AccountController {
    ...
    /**
     * This controller closes the user account by getting the userId from the JWT and the relieving reason
    ...
    public ResponseEntity<ApiResponse> closeAccount(
            @RequestHeader("Authorization") String jwt,
            @RequestBody String relievingReason) {
        try {
            accountService.closeAccount(jwtService.extractUserIdFromToken(jwt), relievingReason);
